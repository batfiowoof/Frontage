...
set "RTSMODE=%~1"
set "RTSARG=%~2"
REM Fonts, icons and sprites load from the import cache, which is not in the repository.
REM Build it once on a fresh clone; the headless gates never draw, so they do not need it.
if not exist "%RTSPROJ%\.godot\imported" "C:\Users\bojid\Downloads\Godot_v4.7.2-stable_win64.exe\Godot_v4.7.2-stable_win64.exe" --path "%RTSPROJ%" --headless --import
