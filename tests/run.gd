...
const TESTS := [
	...
	"res://tests/test_battle_fog.gd",
	"res://tests/test_pathing.gd",
	"res://tests/test_save.gd",
	"res://tests/test_techs.gd",
	"res://tests/test_veterancy.gd",
	"res://tests/test_fog.gd",
	"res://tests/test_founding.gd",
	"res://tests/test_empire.gd",
	"res://tests/test_command.gd",
	"res://tests/test_siege.gd",
	"res://tests/test_diplomacy.gd",
	"res://tests/test_barbarians.gd",
